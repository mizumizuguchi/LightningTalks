...
//    {
//        if (getDistance(Cursor.Position, new Point(this.Location.X + this.Width / 2, this.Location.Y + this.Height / 2)) <= CLOCK_RADIUS)
//        {
//            clockAlpha = getDistance(Cursor.Position, new Point(this.Location.X + this.Width / 2, this.Location.Y + this.Height / 2)) / 100f;
//        }
//        else
